...
CREATE TABLE IF NOT EXISTS public.pos_order_status_dim (
...
INSERT INTO public.pos_order_status_dim (
    status_code,
    status_name,
    status_bucket,
    is_sales,
...
ALTER TABLE public.pos_product_dim
...
ALTER TABLE public.pos_branch_dim
